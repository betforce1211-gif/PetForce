---
description: "Autonomous bug fix with testing and quality gates"
argument-hint: "DESCRIPTION [--max-iterations N] [--skip-tests]"
---
...
Running: /openspec:proposal "BugFix: {DESCRIPTION}"
```
...
Use Skill tool to invoke openspec:apply.
